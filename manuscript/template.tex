...
\noindent HR-VILAGE-3K3M's scope is deliberately limited to gene expression and antibody-response data, harmonized uniformly across all 66 studies. Most constituent studies have no other modality available; a small number (5/66) have companion multi-omic data at their original source (e.g.\ scRNA-seq, CITE-seq, autoantibody panels) that is not included here, listed with accessions in Supplementary Table 2 for users who wish to pursue them directly.
