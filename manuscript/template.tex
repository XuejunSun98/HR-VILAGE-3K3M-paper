...
\noindent\textbf{\texttt{bulk\_gene\_expr\_raw/}.} One CSV file per study, named \texttt{<study\_ID>\_raw.csv}, containing the raw, unnormalized probe-level or gene-level expression matrix (probe/gene-by-sample) as available from the original source, provided to support custom reprocessing.
