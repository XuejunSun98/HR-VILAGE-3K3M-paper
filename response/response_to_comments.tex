...
\textbf{(Ruilie, please modify the license.)}}
...
DOI/DataCite integration (\url{https://doi.org/10.57967/hf/9892}; see E11). \textbf{[PENDING: the
repository license is being changed to CC-BY (via the \texttt{license} field in the dataset card's
YAML metadata), repository metadata (full author list, title) is being completed, and the dataset
card is being updated to display the DOI-based citation -- to be confirmed once done on the
Hugging Face side.]}}
